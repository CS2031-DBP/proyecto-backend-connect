...
import dbp.connect.ChatIndividual.DTO.PostChatIndividualDTO;
...
public class ChatIndividualController {
    ...
    public ResponseEntity<ChatIndividual> createChat(@RequestBody PostChatIndividualDTO chat) throws URISyntaxException {
        if (chat.getId() != null) {
